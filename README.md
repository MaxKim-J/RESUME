...
**초기 단계 스타트업에서 스스로 학습하는 방법을 깨우치며 성장해왔습니다.** 작은 규모의 개발팀에서 조직의 한정된 리소스를 고려하고 해결책을 검증하며 업무 중 발생한 여러 기술적 문제들에 대한 최적의 방법을 찾으려 노력했습니다. 
...
**지식과 경험을 정리하고 공유하는 것을 좋아합니다.** 기술 블로그를 운영하며 지식과 경험을 정리하고, 매주 기술 세션 스터디에 참여하며 원격 기술 세션을 진행하고 있습니다. 지식과 경험을 보기 좋은 문서와 세션으로 정리하고 공유하며 팀원들과 "같이 성장하는" 개발자가 되고자 합니다.
